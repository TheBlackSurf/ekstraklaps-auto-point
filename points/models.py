...
class ProfilePoint(models.Model):
    ...
    color = models.CharField(max_length=200, choices=COLOR, null=True, blank=True)
    ...
    objects = AnnotationManager(
        gross=F('kolejka1') + F('kolejka2') + F('kolejka3') + F('kolejka4') + F('kolejka5') + F('kolejka6') + F(
            'kolejka7') + F('kolejka8') + F('kolejka9') + F('kolejka10') + F('kolejka11') + F('kolejka12') + F(
            'kolejka13') + F('kolejka14') + F('kolejka15') + F('kolejka16') + F('kolejka17') +
              F('kolejka18') + F('kolejka19') + F('kolejka20') + F('kolejka21') + F('kolejka22') + F('kolejka23') + F(
            'kolejka24') + F('kolejka25') +
